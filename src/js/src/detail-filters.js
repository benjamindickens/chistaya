...
class DetailFilters {
    constructor(target, slider, renderSlide, renderPag, params) {
        ...
        if (this._params['options']) {
            ...
            this._elRoot.innerHTML = DetailFilters.template(this._params);
        }
    ...
    _update(option) {
        ...
        const selectType = this._elToggle.name;
        filterData[selectType] = option.dataset['value'];
        this._updateContent(filterData)
